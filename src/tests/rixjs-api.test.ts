...
describe('rixjs-api', () => {
    ...
    it('getAbi returns an abi', async () => {
        const response = await api.getAbi('testrixtoken');
    ...
    it('getContract returns a contract', async () => {
        const response = await api.getContract('testrixtoken');
